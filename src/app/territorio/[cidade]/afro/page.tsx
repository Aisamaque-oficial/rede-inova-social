...
export default async function AfroPage({ params }: { params: Promise<{ cidade: string }> }) {
    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 font-display tracking-tight">
          Movimento Coletivo Afro em {city.name}
        </h1>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 mt-8">
          ...
          <p className="text-lg text-slate-600">
            Estamos organizando as informações, histórias de resistência e iniciativas do movimento afro de {city.name} para compartilhar com você em breve.
          </p>
        </div>
      </div>
    </div>
