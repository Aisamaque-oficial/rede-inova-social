...
export default function NutritionHero() {
    ...
    return (
        <section ref={containerRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-[#0a0f0d]">
            ...
            <div className="absolute inset-0 opacity-[0.05] pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/p6.png')] z-5" />
                    ...
                    >
                        <div className="bg-slate-900/60 rounded-[2.3rem] p-8 md:p-12 border border-white/5">
                            ...
                            <h1 className="text-4xl md:text-7xl font-black tracking-tighter text-white mb-6 font-headline leading-[0.9] italic group-hover:scale-[1.01] transition-transform duration-700 uppercase">
                                ...
                                <span className="text-emerald-500 not-italic underline decoration-emerald-500/20 decoration-4 underline-offset-8">Transformando</span> Territórios
                            </h1>
                            
                            <div className="max-w-2xl mx-auto space-y-4">
                                <p className="text-lg md:text-xl text-slate-200 font-medium leading-relaxed italic">
                                    A Rede Inova é um processo vivo de articulação entre ciência pública, comunidades e movimentos sociais.
                                </p>
                                <p className="text-sm font-bold text-slate-400 max-w-lg mx-auto">
                                    Conheça a trajetória da construção da nossa rede de inovação social no Médio Sudoeste Baiano.
                                </p>
                            </div>
